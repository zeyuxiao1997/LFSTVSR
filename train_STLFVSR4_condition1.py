...
from options import *
from datasets import Dataset4Sintel_condition1
...
def train():
    ...
    train_data = Dataset4Sintel_condition1.DatasetFromFolder(opt)
    ...
    opt.group_file = '/disk3/zeyuxData/LFVideo/Sintel_LFV_9x9/LFSTVSRGroups/ValidGroups.txt'
    val_data = Dataset4Sintel_condition1.DatasetFromFolderValid(opt)
