...
from models import LFSTVSR4_condition4
from utils.myutils import *
import torch.backends.cudnn as cudnn
from options import *
from datasets import Dataset4Sintel_condition4
...
def train():
    ...
    opt.model_path = ''
    opt.group_file = '/disk3/zeyuxData/LFVideo/Sintel_LFV_9x9/LFSTVSRGroups/TrainGroups_Condition4.txt'
    train_data = Dataset4Sintel_condition4.DatasetFromFolder(opt)
    ...
    # opt.group_file = '/gdata1/liuyt2/LFVideo/Sintel_LFV_9x9/LFSTVSRGroups/LFSTVSRGroupsCondition4/ValidGroups.txt'
    # val_data = Dataset4Sintel_condition4.DatasetFromFolderValid(opt)
    ...
    ##############################################################
    model = LFSTVSR4_condition4.LFSTVSR()
    model.train()
    model.cuda()
