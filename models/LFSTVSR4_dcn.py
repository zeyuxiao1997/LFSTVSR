...
class LFSTVSR(nn.Module):
    ...
    def forward(self, centerView1, one1, two1, three1, centerView3, one3, two3, three3):
        ...
        two1_fea = self.lrelu(self.conv_first_two(two1.view(-1, C_one, H_one, W_one)))
        two1_fea = self.feature_extraction_two(two1_fea)
        two3_fea = self.lrelu(self.conv_first_two(two3.view(-1, C_one, H_one, W_one)))
        two3_fea = self.feature_extraction_two(two3_fea)  # torch.Size([8, 64, 128, 52])

        three1_fea = self.lrelu(self.conv_first_three(three1.view(-1, C_one, H_one, W_one)))
        three1_fea = self.feature_extraction_three(three1_fea)
        three3_fea = self.lrelu(self.conv_first_three(three3.view(-1, C_one, H_one, W_one)))
        ...
        two1_fea = two1_fea.view(B_two, 8, -1, H_one, W_one)
        two3_fea = two3_fea.view(B_two, 8, -1, H_one, W_one)
        three1_fea = three1_fea.view(B_three, 8, -1, H_one, W_one)
        three3_fea = three3_fea.view(B_three, 8, -1, H_one, W_one)
        ...
        two1_1 = self.two1_prealign1(two1_fea[:,0,:,:,:].contiguous(),centerView1_L1_fea)
        two1_2 = self.two1_prealign2(two1_fea[:,1,:,:,:].contiguous(),centerView1_L1_fea)
        two1_3 = self.two1_prealign3(two1_fea[:,2,:,:,:].contiguous(),centerView1_L1_fea)
        two1_4 = self.two1_prealign4(two1_fea[:,3,:,:,:].contiguous(),centerView1_L1_fea)
        two1_5 = self.two1_prealign5(two1_fea[:,4,:,:,:].contiguous(),centerView1_L1_fea)
        two1_6 = self.two1_prealign6(two1_fea[:,5,:,:,:].contiguous(),centerView1_L1_fea)
        two1_7 = self.two1_prealign7(two1_fea[:,6,:,:,:].contiguous(),centerView1_L1_fea)
        two1_8 = self.two1_prealign8(two1_fea[:,7,:,:,:].contiguous(),centerView1_L1_fea)
        three1_1 = self.three1_prealign1(three1_fea[:,0,:,:,:].contiguous(),centerView1_L1_fea)
        three1_2 = self.three1_prealign2(three1_fea[:,1,:,:,:].contiguous(),centerView1_L1_fea)
        three1_3 = self.three1_prealign3(three1_fea[:,2,:,:,:].contiguous(),centerView1_L1_fea)
        three1_4 = self.three1_prealign4(three1_fea[:,3,:,:,:].contiguous(),centerView1_L1_fea)
        three1_5 = self.three1_prealign5(three1_fea[:,4,:,:,:].contiguous(),centerView1_L1_fea)
        three1_6 = self.three1_prealign6(three1_fea[:,5,:,:,:].contiguous(),centerView1_L1_fea)
        three1_7 = self.three1_prealign7(three1_fea[:,6,:,:,:].contiguous(),centerView1_L1_fea)
        three1_8 = self.three1_prealign8(three1_fea[:,7,:,:,:].contiguous(),centerView1_L1_fea)
        ...
        two3_1 = self.two3_prealign1(two3_fea[:,0,:,:,:].contiguous(),centerView3_L1_fea)
        two3_2 = self.two3_prealign2(two3_fea[:,1,:,:,:].contiguous(),centerView3_L1_fea)
        two3_3 = self.two3_prealign3(two3_fea[:,2,:,:,:].contiguous(),centerView3_L1_fea)
        two3_4 = self.two3_prealign4(two3_fea[:,3,:,:,:].contiguous(),centerView3_L1_fea)
        two3_5 = self.two3_prealign5(two3_fea[:,4,:,:,:].contiguous(),centerView3_L1_fea)
        two3_6 = self.two3_prealign6(two3_fea[:,5,:,:,:].contiguous(),centerView3_L1_fea)
        two3_7 = self.two3_prealign7(two3_fea[:,6,:,:,:].contiguous(),centerView3_L1_fea)
        two3_8 = self.two3_prealign8(two3_fea[:,7,:,:,:].contiguous(),centerView3_L1_fea)
        three3_1 = self.three3_prealign1(three3_fea[:,0,:,:,:].contiguous(),centerView3_L1_fea)
        three3_2 = self.three3_prealign2(three3_fea[:,1,:,:,:].contiguous(),centerView3_L1_fea)
        three3_3 = self.three3_prealign3(three3_fea[:,2,:,:,:].contiguous(),centerView3_L1_fea)
        three3_4 = self.three3_prealign4(three3_fea[:,3,:,:,:].contiguous(),centerView3_L1_fea)
        three3_5 = self.three3_prealign5(three3_fea[:,4,:,:,:].contiguous(),centerView3_L1_fea)
        three3_6 = self.three3_prealign6(three3_fea[:,5,:,:,:].contiguous(),centerView3_L1_fea)
        three3_7 = self.three3_prealign7(three3_fea[:,6,:,:,:].contiguous(),centerView3_L1_fea)
        three3_8 = self.three3_prealign8(three3_fea[:,7,:,:,:].contiguous(),centerView3_L1_fea)

        left_fea = self.concat1(torch.cat((centerView1_L1_fea,one1_1,one1_2,one1_3,one1_4,one1_5,one1_6,one1_7,one1_8,\
                                            two1_1,two1_2,two1_3,two1_4,two1_5,two1_6,two1_7,two1_8,\
                                            three1_1,three1_2,three1_3,three1_4,three1_5,three1_6,three1_7,three1_8),dim=1))
        right_fea = self.concat3(torch.cat((centerView3_L1_fea,one3_1,one3_2,one3_3,one3_4,one3_5,one3_6,one3_7,one3_8,\
                                            two3_1,two3_2,two3_3,two3_4,two3_5,two3_6,two3_7,two3_8,\
                                            three3_1,three3_2,three3_3,three3_4,three3_5,three3_6,three3_7,three3_8),dim=1))
