...
class LFSTVSR(nn.Module):
    def __init__(self):
        ...
        self.FeatureSelectionReduction_one1 = FeatureSelectionReduction(self.nf*5, self.nf)
        self.FeatureSelectionReduction_one3 = FeatureSelectionReduction(self.nf*5, self.nf)
        self.FeatureSelectionReduction_two1 = FeatureSelectionReduction(self.nf*3, self.nf)
        self.FeatureSelectionReduction_two3 = FeatureSelectionReduction(self.nf*3, self.nf)
        self.FeatureSelectionReduction_three1 = FeatureSelectionReduction(self.nf*3, self.nf)
        self.FeatureSelectionReduction_three3 = FeatureSelectionReduction(self.nf*3, self.nf)
