...
class LFSTVSR(nn.Module):
    def __init__(self):
        ...
        self.FeatureSelectionReduction_two1 = FeatureSelectionReduction(self.nf*5, self.nf)
        self.FeatureSelectionReduction_two3 = FeatureSelectionReduction(self.nf*5, self.nf)
        self.FeatureSelectionReduction_three1 = FeatureSelectionReduction(self.nf*5, self.nf)
        self.FeatureSelectionReduction_three3 = FeatureSelectionReduction(self.nf*5, self.nf)
