...
class LFSTVSR(nn.Module):
    ...
    def forward(self, centerView1, one1, two1, three1, centerView3, one3, two3, three3):
        ...
        two1_fea = two1_fea.view(B_two, -1, H_one, W_one)
        two3_fea = two3_fea.view(B_two, -1, H_one, W_one)
        three1_fea = three1_fea.view(B_three, -1, H_one, W_one)
        three3_fea = three3_fea.view(B_three, -1, H_one, W_one)

        left_fea = self.concat1(torch.cat((centerView1_L1_fea,one1_fea,two1_fea,three1_fea),dim=1))
        right_fea = self.concat1(torch.cat((centerView3_L1_fea,one3_fea,two3_fea,three3_fea),dim=1))
