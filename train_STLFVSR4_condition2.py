...
from models import LFSTVSR4_condition2
from utils.myutils import *
import torch.backends.cudnn as cudnn
from options import *
from datasets import Dataset4Sintel_condition2
...
def train():
    ...
    opt.model_path = ''
    opt.group_file = '/disk3/zeyuxData/LFVideo/Sintel_LFV_9x9/LFSTVSRGroups/TrainGroups_Condition2.txt'
    train_data = Dataset4Sintel_condition2.DatasetFromFolder(opt)
    ...
    # opt.group_file = '/gdata1/liuyt2/LFVideo/Sintel_LFV_9x9/LFSTVSRGroups/LFSTVSRGroupsCondition2/ValidGroups.txt'
    # val_data = Dataset4Sintel_condition2.DatasetFromFolderValid(opt)
    ...
    ##############################################################
    model = LFSTVSR4_condition2.LFSTVSR()
    model.train()
    model.cuda()
