...
# import loss.PerceptualSimilarity.networks_basic as networks
from loss.PerceptualSimilarity import networks_basic as networks
...
class DistModel(BaseModel):
    ...
    def get_current_visuals(self):
        ...
        ref_img = ensor2im(self.var_ref.data)
