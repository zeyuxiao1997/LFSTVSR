...
def inference():
    ...
    group_file = '/disk3/zeyuxData/LFVideo/released_dataset/LFSTVSRGroups/TestGroupsCondition1_new.txt'
    saveRoot = '/disk3/zeyuxData/LFVideo/released_dataset/Stage2Result/Ours'
