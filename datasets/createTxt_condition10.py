    ...
    for vid in vidsValid:
        ...
        for view in condition10:
            ...
            for idx in range(0, frameNum-2,1):
                ...
                print(groups)
                with open(os.path.join(outputdir, 'ValidGroups.txt'), 'a') as f:
                    f.write(groups + '\n')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='/disk3/zeyuxData/LFVideo/Sintel_LFV_9x9/LFSTVSRGroupsCondition10', metavar='PATH', help='output dir to save group txt files')
