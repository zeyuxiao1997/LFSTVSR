...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='/disk3/zeyuxData/LFVideo/Sintel_LFV_9x9/LFSTVSRGroupsCondition2', metavar='PATH', help='output dir to save group txt files')
