...
condition7 = ['00_03','00_04','00_05',\
              '03_00','03_08',\
              '04_00','04_08',\
              '05_00','05_08',\
              '08_03','08_04','08_05']  # 5 5 5 
    ...
    for vid in vidsTrain:
        ...
        for view in condition7:
            ...
            for idx in range(0, frameNum-2,1):
                ...
                print(groups)
                with open(os.path.join(outputdir, 'TrainGroups.txt'), 'a') as f:
                    f.write(groups + '\n')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='/disk3/zeyuxData/LFVideo/Sintel_LFV_9x9/LFSTVSRGroupsCondition7', metavar='PATH', help='output dir to save group txt files')
